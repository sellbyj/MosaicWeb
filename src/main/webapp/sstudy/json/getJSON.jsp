...
<h1>이기종 간에  데이타 통신 밥법</h1>
<ol>
	<li>COMMA seperator(ex==> 10,총무부,서울)</li>
	<li>XML</li>
	<li>JSON</li>
...
<script type="text/javascript">
	...
	$.getJSON("/study/json/dept.json", function(data) {
		...
		var li = '<li class="list-group-item">' + data.detpno+ "," + data.dname + "," + data.loc + "</li>";
	...
	$('button').eq(1).on('click' , function() {
		...
		$.getJSON("/study/json/depts.json", function(data) {
			...
			for(var i =0; i<data.length; i++){
 			  ...
 			  lis += '<li class="list-group-item list-group-item-success">' + data[i].detpno+ "," + data[i].dname + "," + data[i].loc + "</li>";
			}
